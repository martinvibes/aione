    ...
    >
      <div className="container py-6 ">
        <div className="mb-6">
          ...
          <motion.div
            className="flex bg-aqwaGreen flex-col justify-between gap-4 rounded-lg p-6 text-white sm:flex-row sm:items-center"
          ...
          >
            <div className="flex items-center gap-3">
              ...
              >
                <span className="text-lg font-bold">{coin_info?.symbol}</span>
              </motion.div>
              <div>
